...
<template>
    <div class="p2 attr-panel">
        <div class="h28px font-bold text-xs flex justify-between items-center"
            ...
            <div>
                ...
                <a-button v-if="!hiddenAdd" :disabled="disableAdd" size="small" class="icon-btn" @click="clickAdd">
                    <template #icon>
                        <icon-plus />
                    </template>
                </a-button>
