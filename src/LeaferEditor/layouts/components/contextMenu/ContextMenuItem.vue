      ...
      <slot>
          ...
          <div :class="['mx-icon-placeholder', preserveIconWidth ? 'preserve-width' : '']">
            <slot name="icon">
              ...
              <i v-else-if="typeof icon === 'string' && icon !== ''"
                :class="icon + ' icon ' + iconFontClass + ' ' + globalIconFontClass"></i>
            </slot>
        ...
        <div class="mx-item-row">
          <slot v-if="shortcut" name="shortcut">
            <VNodeRender v-if="globalHasSlot('itemShortcutRender')" :vnode="vnodeItemShortcutRender" />
            <span class="mx-shortcut">{{ shortcut }}</span>
          </slot>
          <slot v-if="showRightArrow" name="rightArrow">
            <VNodeRender v-if="globalHasSlot('itemRightArrowRender')" :vnode="vnodeItemRightArrowRender" />
